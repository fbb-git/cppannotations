...
/*  A Bison parser, made from gramspec/grammar  */
...
const int YY_Parser_CLASS::DONE=258;
const int YY_Parser_CLASS::INT=259;
const int YY_Parser_CLASS::DOUBLE=260;
const int YY_Parser_CLASS::UnaryMinus=261;
...
static const short yyprhs[] = {     0,
     0,     3,     5,     8,    11,    13,    16,    20,    24,    28,
    31,    33,    37,    41,    45,    49,    53,    57,    61,    64
};

#endif

static const short yyrhs[] = {    13,
    14,     0,    14,     0,    15,     9,     0,    16,     9,     0,
     9,     0,     1,     9,     0,    15,     7,    15,     0,    15,
     6,    15,     0,    10,    15,    11,     0,    12,    15,     0,
     4,     0,    16,     7,    16,     0,    16,     6,    16,     0,
    16,     7,    15,     0,    16,     6,    15,     0,    15,     7,
    16,     0,    15,     6,    16,     0,    10,    16,    11,     0,
    12,    16,     0,     5,     0
};

#if YY_Parser_DEBUG != 0
static const short yyrline[] = { 0,
    60,    63,    67,    76,    85,    92,   102,   109,   116,   122,
   129,   138,   145,   152,   159,   166,   173,   180,   186,   193
};

static const char * const yytname[] = {   "$","error","$illegal.","DONE","INT",
"DOUBLE","'+'","'*'","UnaryMinus","'\\n'","'('","')'","'-'","lines","line","intExpr",
"doubleExpr",""
};
#endif
...
static const short yydefact[] = {     0,
     0,    11,    20,     5,     0,     0,     0,     2,     0,     0,
     6,     0,     0,    10,    19,     1,     0,     0,     3,     0,
     0,     4,     9,    18,     8,    17,     7,    16,    15,    13,
    14,    12,     0,     0
};
...
static const short yypact[] = {    32,
     2,-32768,-32768,-32768,    -2,    -2,    22,-32768,    42,    46,
-32768,    18,    39,-32768,-32768,-32768,    -2,    -2,-32768,    -2,
    -2,-32768,-32768,-32768,    -3,     7,-32768,-32768,    -3,     7,
-32768,-32768,     9,-32768
};
...
static const short yytable[] = {    12,
    14,     2,     3,    18,    13,    15,     0,     5,    34,     6,
    11,    25,    27,    21,    29,    31,    26,    28,    16,    30,
    32,    33,     1,    17,    18,     2,     3,     0,    23,     0,
     4,     5,     1,     6,     0,     2,     3,     0,     0,     0,
     4,     5,     0,     6,    20,    21,     0,    17,    18,    24,
    19,    20,    21,     0,    22
};

static const short yycheck[] = {     5,
     6,     4,     5,     7,     5,     6,    -1,    10,     0,    12,
     9,    17,    18,     7,    20,    21,    17,    18,     7,    20,
    21,     0,     1,     6,     7,     4,     5,    -1,    11,    -1,
     9,    10,     1,    12,    -1,     4,     5,    -1,    -1,    -1,
     9,    10,    -1,    12,     6,     7,    -1,     6,     7,    11,
     9,     6,     7,    -1,     9
};
  ...
  if (yyssp >= yyss + yystacksize - 1)
    {
      ...
      yyvs = (YY_Parser_STYPE *) alloca (yystacksize * sizeof (*yyvsp));
      __yy_bcopy ((char *)yyvs1, (char *)yyvs, size * sizeof (*yyvsp));
#ifdef YY_Parser_LSP_NEEDED
      yyls = (YY_Parser_LTYPE *) alloca (yystacksize * sizeof (*yylsp));
...
case 3:
#line 70 "gramspec/grammar"
{
#line 12  "startrule.gr0"
            cerr << "RPN: " << d_rpn.str() << endl;
            cerr << "int: " << yyvsp[-1].i << endl;
            d_rpn.str(string());
        ;
    break;}
case 4:
#line 79 "gramspec/grammar"
{
#line 20  "startrule.gr0"
            cerr << "RPN: " << d_rpn.str() << endl;
            cerr << "double: " << yyvsp[-1].d << endl;
            d_rpn.str(string());
        ;
    break;}
case 5:
#line 87 "gramspec/grammar"
{
...
#line 59  "startrule.gr0"
    ...
    break;}
case 11:
#line 131 "gramspec/grammar"
{
#line 65  "startrule.gr0"
            yyval.i = A2x(d_scanner.YYText());
            d_rpn << " " << yyval.i << " ";
        ;
    break;}
case 12:
#line 140 "gramspec/grammar"
{
...
#line 79  "startrule.gr0"
    ...
    break;}
case 14:
#line 154 "gramspec/grammar"
{
#line 85  "startrule.gr0"
            d_rpn << " * ";
            yyval.d = yyvsp[-2].d * yyvsp[0].i;
        ;
    break;}
case 15:
#line 161 "gramspec/grammar"
{
#line 91  "startrule.gr0"
    ...
    break;}
case 16:
#line 168 "gramspec/grammar"
{
#line 97  "startrule.gr0"
            d_rpn << " * ";
            yyval.d = yyvsp[-2].i * yyvsp[0].d;
        ;
    break;}
case 17:
#line 175 "gramspec/grammar"
{
...
#line 114  "startrule.gr0"
    ...
    break;}
case 20:
#line 195 "gramspec/grammar"
{
#line 120  "startrule.gr0"
            yyval.d = A2x(d_scanner.YYText());
            d_rpn << " " << yyval.d << " ";
        ;
    break;}
}
